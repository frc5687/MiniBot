...
public class Constants {
    ...
    public static class Shooter {
        public static final double NORTH_SPEED = 0.2;
        public static final double SOUTH_SPEED = 0.2;
        public static final double NORTH_IDLE_SPEED = 0.1;
        public static final double SOUTH_IDLE_SPEED = 0.1;
